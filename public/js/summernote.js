(function(global, factory) {
  ...
  function splitTree(root, point, options) {
    ...
    return ancestors.reduce(function(node, parent) {
      ...
      return splitNode(
        { node: parent, offset: node ? position(node) : nodeLength(parent) },
        options
      );
    });
  }
  ...
  var WrappedRange = (function() {
    ...
    WrappedRange.prototype.nativeRange = function() {
      if (env.isW3CRangeSupport) {
        ...
        var textRange = pointToTextRange({ node: this.sc, offset: this.so });
    ...
    WrappedRange.prototype.bookmark = function(editable) {
      return {
        s: { path: dom.makeOffsetPath(editable, this.sc), offset: this.so },
        e: { path: dom.makeOffsetPath(editable, this.ec), offset: this.eo }
      };
    };
  ...
  var Style = (function() {
    ...
    Style.prototype.stylePara = function(rng, styleInfo) {
      $$1.each(rng.nodes(dom.isPara, { includeAncestor: true }), function(
        idx,
        para
      ) {
      ...
      $$1.each(clustereds, function(idx, paras) {
        ...
        var lastList =
          headList.childNodes.length > 1
            ? dom.splitTree(
                headList,
                { node: last.parentNode, offset: dom.position(last) + 1 },
  ...
  var Editor = (function() {
    function Editor(context) {
      ...
      this.lineHeight = this.wrapCommand(function(value) {
        _this.style.stylePara(_this.createRange(), { lineHeight: value });
      });
  ...
  var LinkTop = (function() {
    ...
    LinkTop.prototype.update = function() {
      ...
      if (rng.isCollapsed() && rng.isOnAnchor()) {
        ...
        this.$Top.css({ display: "block", left: pos.left, top: pos.top });
      } else {
        this.hide();
      }
    };
    ...
    function AirTop(context) {
      ...
      this.events = {
        ...
        "summernote.focusout": function(we, e) {
          ...
          if (
            !e.relatedTarget ||
            !dom.ancestor(e.relatedTarget, func.eq(_this.$Top[0]))
          ) {
            _this.hide();
          }
        }
  ...
  var HintTop = (function() {
    ...
    HintTop.prototype.initialize = function() {
      ...
      this.lastWordRange = null;
      this.$Top = this.ui
        .Top({ className: "note-hint-Top", hideArrow: true, direction: "" })
        .render()
        .appendTo(this.options.container);
      this.$Top.hide();
